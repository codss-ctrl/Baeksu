...
#     def update(self,board_seq, board_title, board_content, attach_file, attach_path, in_date, in_user_id, up_date, up_user_id):
...
if __name__ == "__main__":
    dao = DaoCmt()
#     obj = dao.insert('들어가', '1', 33)

#     print(obj)
#     list = dao.select_list(4)
#     print(list)
#     
#     cnt = dao.delete(cmt_seq, board_seq)
#     print(cnt)
#     
    obj = dao.del_boardcmt(33)
    print(obj)
